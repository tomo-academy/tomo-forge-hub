...
export const employees: Employee[] = [
  // Leadership & Development
  {
    ...
    recentWork: [
      ...
      { title: "Data and Task Abstraction", type: "Data Visulaization", date: "2025-11-11" },
  ...
  // Development Team
  {
    ...
    phone: "+91 93452 87337",
    employeeId: "TOMO-008",
    joinDate: "2025-08-20",
    avatar: "/nithish.jpg",
    bio: "Senior content creator with expertise in modern web technologies.",
    skills: ["React", "Node.js", "MongoDB", "AWS", "Docker", "Microservices"],
    location: "Pattukotai, India",
    availability: "busy",
    stats: {
      videos: 12,
      tasks: 156,
